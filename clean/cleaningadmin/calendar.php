...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/gsb_calendar.dwt" codeOutsideHTMLIsLocked="false" -->
                ...
                <div class="widgetbox">
                    ...
                    <div class="widgetcontent">
                    	<div id="external-events">
                            <div class="external-event">MD Meeting</div>
                            <div class="external-event">MD Visit</div>
                            <div class="external-event">Company party</div>
                            <div class="external-event">Holiday</div>
                            <div class="external-event">New Event</div>
