...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("insert cleaning SET rooms=%s, bathrooms=%s, Balcony=%s, Kitchen_Cupboards=%s, Fridge=%s, Oven=%s, Pantry=%s, After_Party=%s, Carpet_Steam_Clean=%s, Internal_Windows=%s, dateof=%s, timeof=%s, name=%s, phone=%s, email=%s, address=%s, type=%s, enteredby=%s, assign=%s , adate=%s , price=%s ",
...
?>
      ...
      <p><span class="pagetitle">Assign Rework Job </span></p>
...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="stdtable">
       ...
       <tr>
         ...
         <td><input name="rooms" type="text" class="smallinput" id="rooms" value="<?php if( $row_Recordset3['rooms']!=''){echo $row_Recordset3['rooms']; }else{echo '0';}?>"   /></td>
       </tr>
       <tr>
         <td><strong>Bathrooms</strong></td>
         <td><input name="bathrooms" type="text" class="smallinput" id="bathrooms" value="<?php if( $row_Recordset3['bathrooms']!=''){echo $row_Recordset3['bathrooms']; }else{echo '0';}?>"   /></td>
       </tr>
       <tr>
         <td><strong>Balcony </strong></td>
         <td><input name="Balcony" type="text" class="smallinput" id="Balcony" value="<?php if( $row_Recordset3['Balcony']!=''){echo $row_Recordset3['Balcony']; }else{echo '0';}?>"  /></td>
       </tr>
       <tr>
         <td><strong>Kitchen Cupboards</strong></td>
         <td><input name="Kitchen_Cupboards" type="text" class="smallinput" id="Kitchen_Cupboards" value="<?php if( $row_Recordset3['Kitchen_Cupboards']!=''){echo $row_Recordset3['Kitchen_Cupboards']; }else{echo '0';}?>"  /></td>
       </tr>
       <tr>
         <td><strong>Fridge</strong></td>
         <td><input name="Fridge" type="text" class="smallinput" id="Fridge" value="<?php if( $row_Recordset3['Fridge']!=''){echo $row_Recordset3['Fridge']; }else{echo '0';}?>"   /></td>
       </tr>
       <tr>
         <td><strong>Oven</strong></td>
         <td><input name="Oven" type="text" class="smallinput" id="Oven" value="<?php if( $row_Recordset3['Oven']!=''){echo $row_Recordset3['Oven']; }else{echo '0';}?>"  /></td>
       </tr>
       <tr> 
         <td><strong>Pantry</strong></td>
         <td><input name="Pantry" type="text" class="smallinput" id="Pantry" value="<?php if( $row_Recordset3['Pantry']!=''){echo $row_Recordset3['Pantry']; }else{echo '0';}?>"  /></td>
       </tr>
       <tr>
         <td><strong>After Party</strong></td>
         <td><input name="After_Party" type="text" class="smallinput" id="After_Party" value="<?php if( $row_Recordset3['After_Party']!=''){echo $row_Recordset3['After_Party']; }else{echo '0';}?>" readonly="readonly" /></td>
       </tr>
       <tr>
         <td><strong>Carpet Steam Clean</strong></td>
         <td><input name="Carpet_Steam_Clean" type="text" class="smallinput" id="Carpet_Steam_Clean" value="<?php if( $row_Recordset3['Carpet_Steam_Clean']!=''){echo $row_Recordset3['Carpet_Steam_Clean']; }else{echo '0';}?>" readonly="readonly"  /></td>
       </tr>
       <tr>
         <td><strong>Internal_Windows</strong></td>
         <td><input name="Internal_Windows" type="text" class="smallinput" id="Internal_Windows" value="<?php if( $row_Recordset3['Internal_Windows']!=''){echo $row_Recordset3['Internal_Windows']; }else{echo '0';}?>" readonly="readonly"  /></td>
       </tr>
       <tr>
         <td><strong>Price</strong></td>
         <td><input name="price" type="text" class="smallinput" id="price" value="<?php echo $row_Recordset3['price']; ?>" readonly="readonly"  /></td>
       </tr>
       <tr>
