        ...
        <div class="right">
      	<div class="notification">
            ...
            <div class="userinfodrop">
                ...
                <div class="userdata">
                	<h4>Welcome to 7 to 7 Cleaning</h4>
 ...
 print date("d/m/y");?></h2>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="stdtable"  id="ReportTable">
    <tr>
      ...
      <td width="5%" class="external-event" >Edit</td>
      <td width="4%" class="external-event">View</td>
      <td width="5%" class="external-event" >Delete</td>
      </tr>
    ...
    <?php do { ?>
      <tr>
        ...
        <td><div align="center"><a href="edit_mainlist.php?id=<?php echo $row_Recordset1['id']; ?>"><img src="images/edit.png" width="16" height="16" /></a></div></td>
        <td><div align="center"><a href="view_mainlist.php?id=<?php echo $row_Recordset1['id']; ?>"><img src="images/view.png" width="16" height="16" /></a></div></td>
        <td><div align="center"><a href="delete_mainlist.php?id=<?php echo $row_Recordset1['id']; ?>"><img src="images/trash.png" width="15" height="15" onclick="javascript:return confirm('Are you really want to delete?')" /></a></div></td></tr>
