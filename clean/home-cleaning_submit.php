...
?>
    ...
    <script>
    window.location.href='home-cleaning.php?action=upok';
    </script>
	<?php 	
}
else{
?>
    <script>
   window.location.href='home-cleaning.php?action=upno';
    </script>
	<?php }
