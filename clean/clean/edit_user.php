...
$query_Recordset1 = "SELECT * FROM ims_usrpass WHERE sno = $_GET[id]";
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE ims_usrpass SET name=%s, phno=%s, password=%s, service=%s WHERE sno=%s",
...
<?php if(@$_GET['s']=="in"){print("<script>alert('Data Submitted Sucessfully!');</script>");echo('<script>(location.href="add_user.php");</script>');} ?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="stdtable">
  <form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
    ...
    <tr>
      ...
      <td width="71%"><input name="name" type="text" required class="smallinput" id="name" value="<?php echo $row_Recordset1['name']; ?>" />
        <input name="sno" type="hidden" required="required" class="smallinput" id="sno"  value="<?php echo $row_Recordset1['sno']; ?>" /></td>
    </tr>
    <tr>
      <td width="29%"><label for="name" class="marginleft10">Phno</label></td>
      <td><input name="contactno" type="text" class="smallinput" required id="contactno" value="<?php echo $row_Recordset1['phno']; ?>" /></td>
    </tr>
    <tr>
      <td><label for="Size2" class="marginleft10">Password</label></td>
      <td><input name="password" type="text" class="smallinput" required id="password" value="<?php echo $row_Recordset1['password']; ?>" /></td>
    </tr>
    <tr>
      <td colspan="2"><input name="button" type="submit" class="anchorbutton" id="button" value="Update " /></td>
    </tr>
