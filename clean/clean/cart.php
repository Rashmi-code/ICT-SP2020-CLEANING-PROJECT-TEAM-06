...
<body data-offset="200" data-spy="scroll" data-target=".primary-navigation">
	...
	<!-- Cart -->
	<div id="cart-main" class="cart-main ow-section">
		<div class="container">
			<div class="woocommerce row">
				<form method="post" class="col-md-9 col-sm-8 col-xs-7">
					<table class="shop_table cart">
						...
						<tbody>
							<tr class="cart_item">
								<td data-title="Product" class="product-thumbnail">
									<a title="Product Thumbnail" href="#">
										<img class="attachment-shop_thumbnail wp-post-image" src="images/cart/thumb-1.png" alt="thumb-1" />
									</a>					
								</td>
							...
							<tr class="cart_item">
								...
								<td data-title="Quantity" class="product-quantity">
									<div class="quantity">
										<input type="button" value="-" class="qtyminus btn" data-field="quantity4" />
										<input type="text" name="quantity4" value="0" class="qty btn" />
										<input type="button" value="+" class="qtyplus btn" data-field="quantity4" />
									</div>
								</td>
								<td data-title="Total" class="product-subtotal">
									<span class="amount">£36.00</span>
							...
							<tr>
								<td class="actions" colspan="6">
									<div class="coupon">
										<input type="text" placeholder="Coupon code" value="" id="coupon_code" class="input-text" name="coupon_code"> <input type="submit" value="Apply Coupon" name="apply_coupon" class="btn">
									</div>									
								</td>
							</tr>
						</tbody>
				...
				<div class="cart-collaterals col-md-3 col-sm-4 col-xs-5">
