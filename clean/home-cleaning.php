...
<body data-offset="200" data-spy="scroll" data-target=".primary-navigation">
	...
	<div id="page-banner" class="page-banner">
		...
		<div class="page-detail">
			<div class="container">
				<h3 class="page-title">Domestic Cleaning</h3>
  ...
  <tr>
    <td width="50%" bgcolor="#1e4763"><div align="center" style="color:fff; font-size:20px;"><a href="home-cleaning.php" style="border:none; color:#fff; box-shadow:none;">Domestic Cleaning</a></div></td>
    <td width="50%" bgcolor="#fafafa"><div align="center" style="color:#000; font-size:20px;"><a href="end-cleaning.php" style="border:none;box-shadow:none;">End of Lease Cleaning</a></div></td>
  </tr>
</table><br>
				...
				<h3>Home Cleaning <span>Get a Quote !</span></h3>
...
<i class="fa fa-check" style="color:#FFFF00"> </i> Bedrooms<br><br>
...
<input type="checkbox" id="Internal_Windows" name="Internal_Windows" value="Internal Windows" class="classcheck" onChange="viewvalues();"> Internal Windows ------ $45.00<br></td>
  </tr>
  <tr>
